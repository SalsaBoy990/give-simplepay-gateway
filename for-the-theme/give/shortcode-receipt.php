...
$transaction_id  = give_get_payment_meta($donation_id, '_give_payment_transaction_id', true);
...
if ($transaction_id) {
	$give_receipt_args['donation_receipt']['transaction_id'] = [
		'name'    => __('Simplepay Transaction ID', 'give'),
